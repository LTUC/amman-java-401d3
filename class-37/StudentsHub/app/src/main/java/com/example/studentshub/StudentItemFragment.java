...
public class StudentItemFragment extends Fragment {
    ...
    private static final String ARG_PARAM3 = "studentMajor";
    ...
    public static StudentItemFragment newInstance(String mStudentName, int mSchoolYear, String mStudentMajor) {
        ...
        args.putString(ARG_PARAM3, mStudentMajor);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            mStudentMajor = getArguments().getString(ARG_PARAM3);
        }
    }
