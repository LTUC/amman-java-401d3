...
public class StudentAdapter extends RecyclerView.Adapter<StudentAdapter.StudentViewHolder>{
    ...
    public void onBindViewHolder(@NonNull StudentViewHolder holder, int position) {
        ...
        TextView studentMajor = holder.itemView.findViewById(R.id.majorInFragment);

        studentName.setText(holder.student.getStudentname());
        schoolYear.setText(Integer.toString(holder.student.getSchoolyear()));
        studentMajor.setText(holder.student.getStudentMajor().getMajorName());
    }
